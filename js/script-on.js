	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/administrativo.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/construcao-civil.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/consultor-especializado.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-3 col-sm-offset-1">'+
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal-13.png" class="bg-modal">'+
	    				'</div>'+
	    				'<div class="col-sm-7">'+
	    				...
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<div style="position: relative;"><div class="play-button" style="top: 43%;"><img src="../wp-content/themes/ferado/fullpage/images/modal/play-33.svg" class="bg-modal"></div>'+

	    					'<video width="100%" height="100%" poster="../wp-content/themes/ferado/fullpage/images/modal/Modal-14.png">'+
								'<source src="../wp-content/themes/ferado/fullpage/videos/plataforma_online.mp4" type="video/mp4">'+
		...
		'<div id="modal_premios" class="section pp-scrollable">'+
	    	'<div class="content">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row bg1">'+
	    				'<div class="col-sm-2 col-sm-offset-1">'+
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/selo-35.png" class="bg-modal">'+
	    				'</div>'+
	    				'<div class="col-sm-8">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v2-23.png" class="bg-modal">'+
	    	...
	    	'<div class="content">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				...
	    				'</div>'+
	    				'<div class="col-sm-3">'+
							'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v2-28.png" class="bg-modal">'+
	    				'</div>'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v2-26.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v2-27.png" class="bg-modal">'+
	    	...
	    	'<div class="content">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				...
	    				'</div>'+
	    				'<div class="col-sm-3">'+
							'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v2-29.png" class="bg-modal">'+
	    				'</div>'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v2-30.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<div class="play-button"><img src="../wp-content/themes/ferado/fullpage/images/modal/play-33.svg" class="bg-modal"></div>'+

	    					'<video width="100%" height="100%" poster="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-27.png">'+
								'<source src="../wp-content/themes/ferado/fullpage/videos/russel_vagas.mp4" type="video/mp4">'+
								'Your browser does not support the video tag.'+
								'<img data-src="image.png">'+
							'</video>'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-2.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-28.png" class="bg-modal">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-29.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-34.png" class="bg-modal">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-33.png" class="bg-modal">'+
	    	...
	    	'<div class="content">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				...
	    				'</div>'+
	    				'<div class="col-sm-3">'+
							'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-30.png" class="bg-modal">'+
	    				'</div>'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-32.png" class="bg-modal">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				'<div class="col-sm-10 col-sm-offset-1">'+
	    					...
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/Modal_v3-31.png" class="bg-modal">'+
	    	...
	    	'<div class="content">'+
	    		...
	    		'<div class="container-fluid">'+
	    			...
	    			'<div class="row">'+
	    				...
	    				'</div>'+
	    				'<div class="col-sm-5">'+
	    					'<img src="../wp-content/themes/ferado/fullpage/images/modal/contato/maps-28.png" class="map">'+
	    					'<div class="icons">'+
	    						'<a href="https://www.linkedin.com/company/russel-servi%C3%A7os" target="_blank"><img src="../wp-content/themes/ferado/fullpage/images/modal/contato/icon-26.svg"></a>'+
	    						'<a href="https://www.facebook.com/russelservicos" target="_blank"><img src="../wp-content/themes/ferado/fullpage/images/modal/contato/icon-27.svg"></a>'+
	    						'<p>Russel Serviços</p>'+
	    					'</div>'+
	    				'</div>'+
	    			'</div>'+
